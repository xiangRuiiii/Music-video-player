...
import cn.itcast.ks.androidks.fragment.LoveFragment;
...
public class LoveMusicActivityPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init(){
        ...
        intent2 = new Intent(this,LoveMusicService.class);
        ...
        iv_music.setImageResource(LoveFragment.icons[i]);
